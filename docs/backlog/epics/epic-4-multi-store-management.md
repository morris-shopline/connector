...
- 🔄 Refactor 3（Connection 基礎重構）尚未開始，是本 Epic 的前置條件
- 📝 Inbox / Issues：
  - note-2025-11-06-002（測試缺口、UX 改善）
  - note-2025-11-07-001（公開端點檢視）
  - issue-2025-11-06-001、issue-2025-11-07-001 會在 Refactor 3 解決
...
- ⏳ [Refactor 3: Connection 基礎重構](../refactors/refactor-3-connection-foundation.md) 完成並部署
