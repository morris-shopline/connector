...
| Story | 類型 | 所屬 | 狀態 | 完成 Run |
|-------|------|------|------|----------|
| Story 5.1: Next Engine OAuth Flow 與 Platform Adapter | Feature | Epic 5 | ⏳ planned | - |
| Story 5.2: Next Engine Connection Item 與資料讀取 MVP | Feature | Epic 5 | ⏳ planned | - |
| Story 5.3: 前端 Connection UX 延伸與重新授權整合 | Feature | Epic 5 | ⏳ planned | - |

### Epic 6: 多 API 類型支援（Phase 2.1）

| Story | 類型 | 所屬 | 狀態 | 完成 Run |
|-------|------|------|------|----------|
| Story 6.1: GraphQL / Bulk API 能力擴充 | Feature | Epic 6 | ⏳ planned | - |
| Story 6.2: API 類型統一管理模組 | Feature | Epic 6 | ⏳ planned | - |
| Story 6.3: API 類型選擇 UI 與操作流程 | Feature | Epic 6 | ⏳ planned | - |
...
| **Epic 5: Next Engine 多平台 MVP** | Phase 1.3 | Epic 4 完成 + Next Engine 憑證可用 |
| **Epic 6: 多 API 類型支援** | Phase 2.1 | Epic 5 + Platform Capability 決策更新 |
