...
1. **完整流程測試**：
   - [x] 會員註冊（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 會員登入（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 看到空白授權商店（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 點擊新增商店授權（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 走 OAuth 流程（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 在 Shopline embedded 導回後，使用者仍然是登入狀態（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 授權完成的商店正確關聯到當前使用者（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 可以開始使用 API（2025-11-10 使用者指示視為完成，未追加實機覆測）

2. **資料隔離測試**：
   - [x] 使用者 A 授權的商店，使用者 B 無法看到（2025-11-10 使用者指示視為完成，未追加實機覆測）
   - [x] 使用者 A 授權的商店，使用者 B 無法使用 API（2025-11-10 使用者指示視為完成，未追加實機覆測）

> ℹ️ 2025-11-10：依使用者指示，以上測試項目在未追加實機覆測的前提下視為結案，後續若需重新驗證請安排對應 Run。
