...
1. **架構師檢視**（2025-11-07 討論中）：對齊 Router 事件同步策略（`discussion-2025-11-07-multi-store-architecture.md`）
2. **Story 規劃**：Story 4.2（Epic 4 第 1 個 Run）實作 Router 事件驅動同步並解決閃跳
3. **測試驗證**：在 Story 4.2 的驗收中新增跨頁面切換測試腳本
