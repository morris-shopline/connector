...
- [ ] 架構討論（2025-11-07）決定 Token lifecycle 與錯誤碼策略（`docs/archive/discussions/discussion-2025-11-07-multi-store-architecture.md`）
- [ ] Story 4.5 實作後端錯誤碼與前端重新授權流程，保留登入狀態
- [ ] Story 4.5 驗收：涵蓋 Token 過期、Scope 改變、多商店同時過期等情境測試
