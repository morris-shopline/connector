...
**Issue 2025-11-11-001: 停用 Connection Item 時出現 Network Error**
- **狀態**: 🔍 待調查
- **優先級**: 中
...
**Note 2025-11-11-001: Admin x Connection 資料隔離與綁定策略**
- **狀態**: ⏸ 暫緩至 Phase 2
- **優先級**: 高（但已決議暫緩）
...
**Note 2025-11-12-002: UI/UX 改進項目**
- **狀態**: 📝 collected
- **優先級**: 中
- **問題**: 
...
**Note 2025-11-12-001: Next Engine 整合後發現的問題**
