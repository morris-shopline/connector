...
- [x] 新增商店流程將 `userId` 綁定登入使用者（2025-11-10 使用者指示視為完成，待後續實機 OAuth 佐證）
...
| 新增商店綁定使用者 | ✅ | 2025-11-10 使用者指示視為完成（若需實機 OAuth 覆測將另行安排） |
...
## 阻塞 / 風險
- Story 3.4 / 3.5 仍僅以 code review 驗證；2025-11-10 使用者簽核後暫視為結案，若需實機流程請在後續 Run 排程

---

**最後更新**: 2025-11-10 09:00
