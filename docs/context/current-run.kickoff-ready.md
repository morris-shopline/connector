...
**開始時間**: 2025-11-10（預定）  
**完成時間**: -  
**狀態**: 🧭 kickoff-ready（Story / 架構師規格已備妥，待完成 Kickoff Review）

---

## 任務範圍（粗列，待 Story 展開）

- [`Story R1.1`](../backlog/stories/story-r1-1-multi-platform-state.md)（ready-for-dev）：登入 / 登出 / 授權流程對齊、Zustand + Router Query 擴展，關閉 Issue 2025-11-06-001。
